...
![obscura](https://repo.x-cmd.io/obscura.svg?lang=zh)
...
合计: **180,673** 行代码（覆盖前 5 种语言、共 **291** 个文件）。
...
- **上游仓库**: <https://github.com/h4ckf0r0day/obscura>
- **官网**: <https://obscura.sh>
- **许可证**: Apache-2.0
...
- **Star**: 26,882 · **Fork**: 1,973 · **开放 issue**: 442 · **贡献者**: 67

## 累计统计

- **发布数**: 15 · **已合并 PR**: 392 · **开放 PR**: 58 · **已关闭 issue**: 376 · **开放 issue**: 66 · **提交数**: 1128
...
在 [repology.org](https://repology.org/project/obscura) 上共有 **3** 个发行版报告此项目。**1** 个 ✅ 已是最新上游版本，**2** 个 ⚠️ 使用旧版本。
...
obscura 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `obscura` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/obscura.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260913.yml` · 2026-09-13T05:41:20Z._
